...
class CustomerRepository {
  ...
  DatabaseReference _ref() {
    ...
    return _isGlobal
        ...
        : database.ref('customers/$_currentUid');
  }

  String get _collectionPath => _isGlobal ? 'customers' : 'customers/$_currentUid';

  String _itemPath(String ownerUid, String id) {
    return _isGlobal ? 'customers/$ownerUid/$id' : 'customers/$_currentUid/$id';
  }
